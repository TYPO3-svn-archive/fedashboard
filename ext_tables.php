...
t3lib_extMgm::addToInsertRecords('tx_fedashboard_widgets');

$TCA['tx_fedashboard_widgets'] = array (
	'ctrl' => array (
		'title'     => 'LLL:EXT:fedashboard/locallang_db.xml:tx_fedashboard_widgets',		
		'label'     => 'uid',	
		'tstamp'    => 'tstamp',
		'crdate'    => 'crdate',
		'cruser_id' => 'cruser_id',
		...
		'iconfile'          => t3lib_extMgm::extRelPath($_EXTKEY).'icon_tx_fedashboard_widgets.gif',
	),
);
?>